...
<body>
    ...
    <div class="mainContent">
        ...
        <div class="list-group">
            ...
            <a href="detail_rute.php" class="list-group-item list-group-item-action d-flex">
                <img src="https://getbootstrap.com/docs/4.6/assets/brand/bootstrap-solid.svg" width="30" height="30" class="d-inline-block mr-2 my-auto" alt="">
                The current link item and realy loong text that doesn't mean anything cuz it's a placeholder
            </a>
